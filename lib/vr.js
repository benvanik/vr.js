 ...
 * @private
 */
Runtime.prototype.detectPlugin_ = function() {
 ...
 * @private
 */
Runtime.prototype.createEmbed_ = function() {
 ...
 * @private
 */
Runtime.prototype.waitForDomReady_ = function(callback, opt_scope) {
 ...
 * @template T
 */
Runtime.prototype.load = function(opt_callback, opt_scope) {
 ...
 * @private
 */
Runtime.prototype.loadDomReady_ = function() {
  // Create <embed>.
 ...
 * @private
 */
Runtime.prototype.completeLoad_ = function(opt_error) {
  // Set state.
  if (opt_error) {
    this.isLoaded = false;
 ...
 * @private
 */
Runtime.prototype.execCommand_ = function(commandId, opt_commandData) {
  if (!this.native_) {
    return '';
  }
 ...
 * @private
 */
Runtime.prototype.queryHmdInfo_ = function() {
 ...
 * This is populated on demand by calling {@link Runtime#poll}.
 * @return {vr.HmdInfo} HMD info, if any.
 */
Runtime.prototype.getHmdInfo = function() {
 ...
 */
Runtime.prototype.resetHmdOrientation = function() {
  this.execCommand_(2);
};
 ...
 * @private
 */
Runtime.prototype.querySixenseInfo_ = function() {
 ...
 */
Runtime.prototype.getSixenseInfo = function() {
 ...
 */
Runtime.prototype.poll = function(state) {
  if (!this.native_) {
    return false;
  }
 ...
 * @private
 */
Runtime.prototype.parseSixenseChunk_ = function(state, data, o) {
  // b,[base#],
  //   c,[controller#],
 ...
 * @private
 */
Runtime.prototype.parseHmdChunk_ = function(state, data, o) {
  if (data.length == 5) {
 ...
 * @private
 */
Runtime.prototype.fullScreenChange_ = function(e) {
 ...
 */
Runtime.prototype.isFullScreen = function() {
  var element =
 ...
 */
Runtime.prototype.enterFullScreen = function() {
 ...
 */
Runtime.prototype.exitFullScreen = function() {
  // Exit fullscreen.
  // The {@link Runtime#fullScreenChange_} handler will move the window back.
 ...
 */
Runtime.prototype.log = function(var_args) {
 ...
 * @alias module vr
 */
var vr = new Runtime(global.document);
