...
vr.DriverDataSource.prototype.poll = function(state) {
  state.hmd.present = true;
  state.hmd.rotation[0] = sensorFusion.Q[0];
  state.hmd.rotation[1] = sensorFusion.Q[1];
  state.hmd.rotation[2] = sensorFusion.Q[2];
  state.hmd.rotation[3] = sensorFusion.Q[3];
};
